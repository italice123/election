...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 01, 2019 at 07:35 PM
...
CREATE TABLE `admin_info` (
  `Admin_Info` decimal(65,0) NOT NULL COMMENT 'รหัสAdmin (PK)	',
  `CREATE_BY` varchar(50) DEFAULT NULL COMMENT 'สร้างโดย	',
  `CREATE_DATE` timestamp NULL DEFAULT NULL COMMENT 'วันที่สร้าง	',
  `UPDATE_BY` varchar(50) DEFAULT NULL COMMENT 'อัพเดตโดย	',
  `UPDATE_DATE` timestamp NULL DEFAULT NULL COMMENT 'วัันที่อัพเดต	',
  `IS_DELETED` char(1) NOT NULL DEFAULT 'N' COMMENT 'ลบ	'
...
CREATE TABLE `admin_log` (
  `Log_ID` decimal(65,0) NOT NULL COMMENT 'รหัส Log (PK)	',
  `Log_Type` varchar(50) NOT NULL COMMENT 'ประเภทLog	',
  `CREATE_BY` varchar(50) DEFAULT NULL COMMENT 'สร้างโดย	',
  `CREATE_DATE` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT 'วันที่สร้าง	',
  `UPDATE_BY` varchar(50) DEFAULT NULL COMMENT 'อัพเดตโดย	',
  `UPDATE_DATE` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT 'วัันที่อัพเดต	',
  `IS_DELETED` char(1) NOT NULL DEFAULT 'N' COMMENT 'ลบ	'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `admin_mt_screen`
--

CREATE TABLE `admin_mt_screen` (
  `Screen_ID` decimal(65,0) NOT NULL COMMENT 'รหัสScreen (PK)	',
  `Screen_Name` varchar(50) DEFAULT NULL COMMENT 'ชื่อ Screen	',
  `CREATE_BY` varchar(50) DEFAULT NULL COMMENT 'สร้างโดย	',
  `CREATE_DATE` timestamp NULL DEFAULT NULL COMMENT 'วันที่สร้าง	',
  `UPDATE_BY` varchar(50) DEFAULT NULL COMMENT 'อัพเดตโดย	',
  `UPDATE_DATE` timestamp NULL DEFAULT NULL COMMENT 'วัันที่อัพเดต	',
...
CREATE TABLE `admin_role` (
  `Role_ID` decimal(65,0) NOT NULL COMMENT 'รหัสAdmin (PK)	',
  `Role_Name` varchar(50) DEFAULT NULL COMMENT 'ชื่อ Admin	',
  `CREATE_BY` varchar(50) DEFAULT NULL COMMENT 'สร้างโดย	',
  `CREATE_DATE` timestamp NULL DEFAULT NULL COMMENT 'วันที่สร้าง	',
  `UPDATE_BY` varchar(50) DEFAULT NULL COMMENT 'อัพเดตโดย	',
  `UPDATE_DATE` timestamp NULL DEFAULT NULL COMMENT 'วัันที่อัพเดต	',
...
--
-- Table structure for table `approve_info`
--

CREATE TABLE `approve_info` (
  `app_ID` decimal(65,0) NOT NULL COMMENT 'รหัสอนุมัติ (PK)	',
  `CREATE_BY` varchar(50) DEFAULT NULL COMMENT 'สร้างโดย	',
  `CREATE_DATE` timestamp NULL DEFAULT NULL COMMENT 'วันที่สร้าง	',
  `UPDATE_BY` varchar(50) DEFAULT NULL COMMENT 'อัพเดตโดย	',
  `UPDATE_DATE` timestamp NULL DEFAULT NULL COMMENT 'วัันที่อัพเดต	',
...
CREATE TABLE `document_info` (
  `Doc_ID` decimal(65,0) NOT NULL COMMENT 'รหัสDoc (PK)	',
  `Doc_Name` varchar(50) DEFAULT NULL COMMENT 'ชื่อ Doc	',
  `CREATE_BY` varchar(50) DEFAULT NULL COMMENT 'สร้างโดย	',
  `CREATE_DATE` timestamp NULL DEFAULT NULL COMMENT 'วันที่สร้าง	',
  `UPDATE_BY` varchar(50) DEFAULT NULL COMMENT 'อัพเดตโดย	',
  `UPDATE_DATE` timestamp NULL DEFAULT NULL COMMENT 'วัันที่อัพเดต	',
...
--
-- Table structure for table `document_mt_type`
--

CREATE TABLE `document_mt_type` (
  `Doc_Type_ID` decimal(65,0) NOT NULL COMMENT 'รหัสประเภท (PK)	',
  `Type_Name` varchar(50) DEFAULT NULL COMMENT 'ชื่อ ประภท	',
  `CREATE_BY` varchar(50) DEFAULT NULL COMMENT 'สร้างโดย	',
  `CREATE_DATE` timestamp NULL DEFAULT NULL COMMENT 'วันที่สร้าง	',
  `UPDATE_BY` varchar(50) DEFAULT NULL COMMENT 'อัพเดตโดย	',
  `UPDATE_DATE` timestamp NULL DEFAULT NULL COMMENT 'วัันที่อัพเดต	',
...
--
-- Table structure for table `electorate_info`
--

CREATE TABLE `electorate_info` (
  `E_ID` decimal(65,0) NOT NULL COMMENT 'รหัสหน่วย (PK)	',
  `CREATE_BY` varchar(50) DEFAULT NULL COMMENT 'สร้างโดย	',
  `CREATE_DATE` timestamp NULL DEFAULT NULL COMMENT 'วันที่สร้าง	',
  `UPDATE_BY` varchar(50) DEFAULT NULL COMMENT 'อัพเดตโดย	',
  `UPDATE_DATE` timestamp NULL DEFAULT NULL COMMENT 'วัันที่อัพเดต	',
...
--
-- Table structure for table `electorate_mt_area`
--

CREATE TABLE `electorate_mt_area` (
  `Area_ID` decimal(65,0) NOT NULL COMMENT 'รหัสพื้นที่ (PK)',
  `CREATE_BY` varchar(50) DEFAULT NULL COMMENT 'สร้างโดย	',
  `CREATE_DATE` timestamp NULL DEFAULT NULL COMMENT 'วันที่สร้าง	',
  `UPDATE_BY` varchar(50) DEFAULT NULL COMMENT 'อัพเดตโดย	',
  `UPDATE_DATE` timestamp NULL DEFAULT NULL COMMENT 'วัันที่อัพเดต	',
...
--
-- Table structure for table `mt_districts`
--

CREATE TABLE `mt_districts` (
...
--
-- Dumping data for table `mt_districts`
--

INSERT INTO `mt_districts` (`id`, `zip_code`, `name_th`, `name_en`, `amphure_id`) VALUES
...
--
-- Table structure for table `mt_part`
--

CREATE TABLE `mt_part` (
  `id` int(11) NOT NULL,
  `name` varchar(255) COLLATE utf8_bin NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='InnoDB free: 8192 kB';

--
-- Dumping data for table `mt_part`
--

INSERT INTO `mt_part` (`id`, `name`) VALUES
(1, 'ภาคเหนือ'),
(2, 'ภาคกลาง'),
...
--
-- Table structure for table `mt_provinces`
--

CREATE TABLE `mt_provinces` (
  `id` int(5) NOT NULL,
...
--
-- Dumping data for table `mt_provinces`
--

INSERT INTO `mt_provinces` (`id`, `code`, `name_th`, `name_en`, `geography_id`) VALUES
...
--
-- Table structure for table `mt_subdistricts`
--

CREATE TABLE `mt_subdistricts` (
  `id` int(5) NOT NULL,
...
--
-- Dumping data for table `mt_subdistricts`
--

INSERT INTO `mt_subdistricts` (`id`, `code`, `name_th`, `name_en`, `province_id`) VALUES
...
CREATE TABLE `news_info` (
  `News_ID` decimal(65,0) NOT NULL COMMENT 'รหัสข่าว(PK)	',
  `News_Name` varchar(50) DEFAULT NULL COMMENT 'ชื่อข่าว	',
  `CREATE_BY` varchar(50) DEFAULT NULL COMMENT 'สร้างโดย	',
  `CREATE_DATE` timestamp NULL DEFAULT NULL COMMENT 'วันที่สร้าง	',
  `UPDATE_BY` varchar(50) DEFAULT NULL COMMENT 'อัพเดตโดย	',
  `UPDATE_DATE` timestamp NULL DEFAULT NULL COMMENT 'วัันที่อัพเดต	',
...
--
-- Table structure for table `news_mt_type`
--

CREATE TABLE `news_mt_type` (
  `Type_ID` decimal(65,0) NOT NULL COMMENT 'รหัสประเภท (PK)	',
  `Type_Name` varchar(50) DEFAULT NULL COMMENT 'ชื่อ ประภท	',
  `CREATE_BY` varchar(50) DEFAULT NULL COMMENT 'สร้างโดย	',
  `CREATE_DATE` timestamp NULL DEFAULT NULL COMMENT 'วันที่สร้าง	',
  `UPDATE_BY` varchar(50) DEFAULT NULL COMMENT 'อัพเดตโดย	',
...
--
-- Table structure for table `political_party_address`
--

CREATE TABLE `political_party_address` (
  `ADD_ID` decimal(65,0) NOT NULL COMMENT 'รหัสที่อยู่	',
  `CREATE_BY` varchar(50) DEFAULT NULL COMMENT 'สร้างโดย	',
  `CREATE_DATE` timestamp NULL DEFAULT NULL COMMENT 'วันที่สร้าง	',
  `UPDATE_BY` varchar(50) DEFAULT NULL COMMENT 'อัพเดตโดย	',
  `UPDATE_DATE` timestamp NULL DEFAULT NULL COMMENT 'วัันที่อัพเดต	',
...
--
-- Table structure for table `political_party_info`
--

CREATE TABLE `political_party_info` (
  `PP_ID` decimal(65,0) NOT NULL COMMENT 'รหัสพรรค (PK)	',
  `PP_Name` varchar(50) DEFAULT NULL COMMENT 'ชื่อพรรค	',
  `CREATE_BY` varchar(50) DEFAULT NULL COMMENT 'สร้างโดย	',
  `CREATE_DATE` timestamp NULL DEFAULT NULL COMMENT 'วันที่สร้าง	',
  `UPDATE_BY` varchar(50) DEFAULT NULL COMMENT 'อัพเดตโดย	',
  `UPDATE_DATE` timestamp NULL DEFAULT NULL COMMENT 'วัันที่อัพเดต	',
...
--
-- Table structure for table `political_personal_address`
--

CREATE TABLE `political_personal_address` (
  `ADD_ID` decimal(65,0) NOT NULL COMMENT 'รหัสที่อยู่(PK)	',
  `CREATE_BY` varchar(50) DEFAULT NULL COMMENT 'สร้างโดย	',
  `CREATE_DATE` timestamp NULL DEFAULT NULL COMMENT 'วันที่สร้าง	',
  `UPDATE_BY` varchar(50) DEFAULT NULL COMMENT 'อัพเดตโดย	',
  `UPDATE_DATE` timestamp NULL DEFAULT NULL COMMENT 'วัันที่อัพเดต	',
...
--
-- Table structure for table `political_personal_info`
--

CREATE TABLE `political_personal_info` (
  `PP_ID` decimal(65,0) NOT NULL COMMENT 'รหัสผู้สมัคร (PK)	',
  `CREATE_BY` varchar(50) DEFAULT NULL COMMENT 'สร้างโดย	',
  `CREATE_DATE` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT 'วันที่สร้าง	',
  `UPDATE_BY` varchar(50) DEFAULT NULL COMMENT 'อัพเดตโดย	',
  `UPDATE_DATE` timestamp NULL DEFAULT '0000-00-00 00:00:00' COMMENT 'วัันที่อัพเดต	',
  `IS_DELETED` char(1) NOT NULL DEFAULT 'N' COMMENT 'ลบ	'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `political_personal_info_migrate`
--

CREATE TABLE `political_personal_info_migrate` (
  `MIG_ID` decimal(65,0) NOT NULL COMMENT 'รหัสผู้สมัคร (PK)',
  `CREATE_BY` varchar(50) DEFAULT NULL COMMENT 'สร้างโดย	',
  `CREATE_DATE` timestamp NULL DEFAULT NULL COMMENT 'วันที่สร้าง	',
  `UPDATE_BY` varchar(50) DEFAULT NULL COMMENT 'อัพเดตโดย	',
  `UPDATE_DATE` timestamp NULL DEFAULT NULL COMMENT 'วัันที่อัพเดต	',
...
--
-- Table structure for table `political_personal_mt_type`
--

CREATE TABLE `political_personal_mt_type` (
  `Type_ID` decimal(65,0) NOT NULL COMMENT 'รหัสผู้สมัคร (PK)	',
  `Type_Name` varchar(50) DEFAULT NULL COMMENT 'ชื่อประเภท	',
  `CREATE_BY` varchar(50) DEFAULT NULL COMMENT 'สร้างโดย	',
  `CREATE_DATE` timestamp NULL DEFAULT NULL COMMENT 'วันที่สร้าง	',
  `UPDATE_BY` varchar(50) DEFAULT NULL COMMENT 'อัพเดตโดย	',
  `UPDATE_DATE` timestamp NULL DEFAULT NULL COMMENT 'วัันที่อัพเดต	',
...
CREATE TABLE `service_info` (
  `Ser_ID` decimal(65,0) NOT NULL COMMENT 'รหัสบริการ (PK)	',
  `Ser_Name` varchar(50) DEFAULT NULL COMMENT 'ชื่อบริการ	',
  `CREATE_BY` varchar(50) DEFAULT NULL COMMENT 'สร้างโดย	',
  `CREATE_DATE` timestamp NULL DEFAULT NULL COMMENT 'วันที่สร้าง	',
  `UPDATE_BY` varchar(50) DEFAULT NULL COMMENT 'อัพเดตโดย	',
  `UPDATE_DATE` timestamp NULL DEFAULT NULL COMMENT 'วัันที่อัพเดต	',
...
CREATE TABLE `user_info` (
  `USER_ID` decimal(65,0) NOT NULL COMMENT 'รหัสUser (PK)',
  `CREATE_BY` varchar(50) DEFAULT NULL COMMENT 'สร้างโดย',
  `CREATE_DATE` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT 'วันที่สร้าง',
  `UPDATE_BY` varchar(50) DEFAULT NULL COMMENT 'อัพเดตโดย	',
  `UPDATE_DATE` timestamp NULL DEFAULT '0000-00-00 00:00:00' COMMENT 'วัันที่อัพเดต	',
...
--
-- Table structure for table `user_info_migrate`
--

CREATE TABLE `user_info_migrate` (
  `User_ID` decimal(65,0) NOT NULL COMMENT 'รหัสUser (PK)',
  `CREATE_BY` varchar(50) DEFAULT NULL COMMENT 'สร้างโดย	',
  `CREATE_DATE` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT 'วันที่สร้าง	',
  `UPDATE_BY` varchar(50) DEFAULT NULL COMMENT 'อัพเดตโดย	',
...
CREATE TABLE `user_log` (
  `Log_ID` decimal(65,0) DEFAULT NULL COMMENT 'รหัส log (PK)	',
  `CREATE_BY` varchar(50) DEFAULT NULL COMMENT 'สร้างโดย	',
  `CREATE_DATE` timestamp NULL DEFAULT NULL COMMENT 'วันที่สร้าง	',
  `UPDATE_BY` varchar(50) DEFAULT NULL COMMENT 'อัพเดตโดย	',
  `UPDATE_DATE` timestamp NULL DEFAULT NULL COMMENT 'วัันที่อัพเดต	',
...
--
-- Table structure for table `user_mt_screen`
--

CREATE TABLE `user_mt_screen` (
  `Screen_ID` decimal(65,0) NOT NULL COMMENT 'รหัสScreen (PK)	',
  `Screen_Name` varchar(50) DEFAULT NULL COMMENT 'ชื่อ Screen	',
  `CREATE_BY` varchar(50) DEFAULT NULL COMMENT 'สร้างโดย	',
  `CREATE_DATE` timestamp NULL DEFAULT NULL COMMENT 'วันที่สร้าง	',
...
--
-- Indexes for table `mt_districts`
--
ALTER TABLE `mt_districts`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `mt_part`
--
ALTER TABLE `mt_part`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `mt_provinces`
--
ALTER TABLE `mt_provinces`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `mt_subdistricts`
--
ALTER TABLE `mt_subdistricts`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `user_info_migrate`
--
ALTER TABLE `user_info_migrate`
  ADD PRIMARY KEY (`User_ID`);
...
--
-- AUTO_INCREMENT for table `mt_part`
--
ALTER TABLE `mt_part`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `mt_provinces`
--
ALTER TABLE `mt_provinces`
  MODIFY `id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=78;

--
-- AUTO_INCREMENT for table `mt_subdistricts`
--
ALTER TABLE `mt_subdistricts`
